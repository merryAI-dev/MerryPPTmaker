...
| 1 | Design | 레퍼런스 PDF/이미지/링크 | `DESIGN.md` | observed/inferred 규칙, 폰트, 팔레트, 금지 패턴이 정리됨 |
| 2 | Plan | `DESIGN.md`, 사용자 자료 | `slide_plan.json` | 설득 흐름과 페이지 역할이 타당함 |
| 3 | Prompt | `DESIGN.md`, `slide_plan.json` | `slide_prompts.json` | 페이지별 프롬프트와 anti-generic ban이 있음 |
| 4 | Render | `slide_prompts.json` | `page_<n>.png` | `gpt-image-2` 기준으로 한 장씩 생성 및 검수됨 |
